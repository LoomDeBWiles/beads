...
| `auto-start-daemon` | - | `BEADS_AUTO_START_DAEMON` | `false` | Auto-start daemon if not running |
...
# Auto-start daemon (default false)
auto-start-daemon: true  # Enable if you want daemon auto-start
