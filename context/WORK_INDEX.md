...
| work/w3_atomic-claim/work_report.md | w3 SHIPPED: `bd claim` is one preconditioned write with an owner lease; two concurrent claimants no longer both win | Reviewing the claim verb, its exit codes and lease rules, or the w3 build |
